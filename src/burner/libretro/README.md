...
* **linking GPL software and non-commercial software is producing a derivative work, extending the GPL license to the non-commercial work** : It is not true under European Law, where the libretro buildbots are located (source [here](https://joinup.ec.europa.eu/collection/eupl/licence-compatibility-permissivity-reciprocity-and-interoperability)), and it is unclear whether it's true or not in other countries.
